...
public class BoneSwordItem extends ThingsElements.ModElement {
	@ObjectHolder("things:bonesword")
	public static final Item block = null;
	public BoneSwordItem(ThingsElements instance) {
		super(instance, 9);
	}
