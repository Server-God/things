...
public class IGoldSwordItem extends ThingsElements.ModElement {
	@ObjectHolder("things:igoldsword")
	public static final Item block = null;
	public IGoldSwordItem(ThingsElements instance) {
		super(instance, 10);
	}
